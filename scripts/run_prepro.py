...
#############################################################pretraining################################################
##################################bookcorpus
make_vocab(config.data.bookcorpus.large, config.vocab.bookcorpus, config.vocab_info.n_token, config.vocab_info.model_name, config.vocab_info.model_type)
...
# import os
# oj = os.path.join
# raw_train = glob.glob("./data/raw/bookcorpus/"+"*")
# prepro_train_dir = "./data/prepro/bookcorpus/"
#
