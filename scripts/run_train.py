...
from src.model import MLMTask
from src.data import *
from src.utils import setup, cleanup, run_demo, print_loss_log
...
def run_main(args, rank=None):
    ...
    if args.dataset == 'WikiText103':
        ...
        from src.data import BookCorpus
    else:
    ...
    if args.dataset == 'WikiText103' or args.dataset == 'WikiText2':
        ...
        test_dataset, valid_dataset = torchtext.experimental.datasets.WikiText2(vocab=vocab,
                                                                                data_select=('test', 'valid'))
